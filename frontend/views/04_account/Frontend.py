...
class FrontendHomePage(tk.Frame):
    def __init__(self, master):
        ...
        tk.Label(self, text="Frontend Home Page", font=(styleDict["fontType"], styleDict["fontSize"], styleDict["fontStyle"])).pack(side="top", fill="x", pady=5)
        tk.Button(self, text="Go to Account Management Page",
                  command = lambda: master.switch_frame(Account.AccountMngPage)).pack()